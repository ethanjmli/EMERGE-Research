...
## c18 p-values 0.05
setwd("/Users/ethan_j_li/Documents/Emory/Research/2020/C18 2020 E-M Plots")
...
list.filenames <- list.files(path = "/Users/ethan_j_li/Documents/Emory/Research/2020/Heatmapping", pattern="mcg_pathwayanalysis.*.xlsx$",full.names = TRUE, recursive = FALSE) 
res<-substring(list.filenames,81,nchar(list.filenames)-5)
res

myData1 <- read_excel('/Users/ethan_j_li/Documents/Emory/Research/2020/Heatmapping/mcg_pathwayanalysis_h_GDM_s1_2020.xlsx')[1:119,]
...
write.csv(Mum_Pathway_V3,"/Users/ethan_j_li/Documents/Emory/Research/2020/Heatmapping/Pathway Summary PreComp 2020.csv")
