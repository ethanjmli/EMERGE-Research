...
hilic_results <- read_delim("/Users/ethan_j_li/OneDrive - Emory University/Research/2020/
                            ComBat_mzcalibrated_untargeted_mediansummarized_featuretable_hilic.txt", 
                    "\t", escape_double = FALSE, trim_ws = TRUE)

c18_results <- read_delim("/Users/ethan_j_li/OneDrive - Emory University/Research/2020/
                          ComBat_mzcalibrated_untargeted_mediansummarized_featuretable_c18.txt", 
                   "\t", escape_double = FALSE, trim_ws = TRUE)
...
hilic_ids <- read.delim("/Users/ethan_j_li/Documents/Emory/Research/2020/R24_mapping_hilicpos.txt")

#CPid20 <- read.delim("/Users/tanyouran/Desktop/Liang/Thesis Materials/DATA_2 update/R24_mapping_c18neg.txt")
c18_ids <- read.delim("/Users/ethan_j_li/Documents/Emory/Research/2020/R24_mapping_c18neg.txt")
...
#in stage 1 or stage 2 of pregnancy
...
table(metotalv1$subjectid)    # 64 obs- 64 usbjects
...
table(metotalv2$subjectid)   # 534 obs- 267 subjects total, 2 visits each: 267+64=331 subjects
...
catVars<-c("Education_4.level","income","PregInsurance_2.level",
           ...
           "Sex","g_htn","g_htn_mod","Comp_gHTNvsHealthyFullTerm","g_dm","PROM","Comp_IUGRvsHealthyFullTerm","mode","birthoutcome","TobaccoUse_MR","AlcoholUse_MR")
...
tab2<-CreateCatTable(vars=catVars, data= amod, includeNA = TRUE)
...
write.csv(h_pre_complication_s1,"h_pre_complication_s1_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1[,i+193] ~Comp_gHTNvsHealthyFullTerm +as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1)
...
write.csv(h_g_htn_s1,"h_g_htn_s1_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1[,i+193] ~Comp_gDMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_g_dm_s1,"h_g_dm_s1_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1[,i+193] ~Comp_PROMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_PROM_s1,"h_PROM_s1_HFT.csv")
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_IUGR_s1,"h_IUGR_s1_HFT.csv")
...
write.csv(h_pre_complication_s2,"h_pre_complication_s2_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2[,i+193] ~Comp_gHTNvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_g_htn_s2,"h_g_htn_s2_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2[,i+193] ~Comp_gDMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_g_dm_s2,"h_g_dm_s2_HFT.csv")
...
for (i in 1:nrow(hilic_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2[,i+193] ~Comp_PROMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_PROM_s2,"h_PROM_s2_HFT.csv")
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(h_IUGR_s2,"h_IUGR_s2_HFT.csv")
#######################################
##########C18####
#CPid<-CPid20
c18ID <- c18_ids
...
write.csv(c_pre_complication_s1,"c_pre_complication_s1_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1_2[,i+193] ~Comp_gHTNvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_g_htn_s1,"c_g_htn_s1_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1_2[,i+193] ~Comp_gDMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_g_dm_s1,"c_g_dm_s1_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals1_2[,i+193] ~Comp_PROMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals1_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_PROM_s1,"c_PROM_s1_HFT.csv")
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_IUGR_s1,"c_IUGR_s1_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2_2[,i+193] ~Comp_gHTNvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_g_htn_s2,"c_g_htn_s2_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2_2[,i+193] ~Comp_gDMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_g_dm_s2,"c_g_dm_s2_HFT.csv")
...
for (i in 1:nrow(c18_results) ) 
{
  tryCatch(
    {
      lmfit<-lm( metotals2_2[,i+193] ~Comp_PROMvsHealthyFullTerm+as.factor(Sex)+age_enrollment+as.factor(nullp)+as.factor(Education_4.level)+FirstPrenatalBMI, data=metotals2_2)
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_PROM_s2,"c_PROM_s2_HFT.csv")
...
#h_InducedPTBETBvsHealthyFullTerm_s1<-cbind(h20[,c(1:2)],h_InducedPTBETBvsHealthyFullTerm_s1)
write.csv(c_IUGR_s2,"c_IUGR_s2_HFT.csv")
...
write.csv(c_pre_complication_s2,"c_pre_complication_s2_HFT.csv")
...
list.files(pattern="h.*HFT.csv$") 
list.filenames <- list.files(pattern="h.*HFT.csv$")
...
write.csv(MWAStatsHILICPreComp,"HILIC 2020 HFT MWAS Stats.csv")
...
write.csv(overlap,"HILIC 2020 HFT Stage 1x2 Overlap.csv")
...
write.csv(MWAStatsC18PreComp,"C18 2020 HFT MWAS Stats.csv")
...
write.csv(overlap,"C18 2020 HFT Stage 1x2 Overlap.csv")
  ...
  tryCatch(
    {
      ...
      #replace 1 with i
      write.table(ACE_ref2, paste0("/Users/ethan_j_li/OneDrive - Emory University/Research/2020 HFT/HILIC 2020 HFT Mummichog txt Input 2020/",polname[i],".txt"),sep="\t",row.names=FALSE)
    },error=function(e){})
}
...
setwd("/Users/ethan_j_li/OneDrive - Emory University/Research/2020 HFT/C18 2020 HFT Regression")
list.files(pattern="c.*HFT.csv$") 
list.filenames <- list.files(pattern="c.*HFT.csv$")
list.filenames
  ...
  tryCatch(
    {
      ...
      write.table(ACE_ref2, paste0("/Users/ethan_j_li/OneDrive - Emory University/Research/2020 HFT/C18 2020 HFT Mummichog txt Input 2020/",polname[i],".txt"),sep="\t",row.names=FALSE)
    },error=function(e){})
}
